(function () {
    ...
    server.version_log_add = function (data, callback) {
        return send('post', contextPath + '/permissions/version/log/add', data, callback);
    };

    //版本日志记录列表
    server.version_log_list = function (data, callback) {
        return send('get', contextPath + '/permissions/version/log/list', data, callback);
    };

    //修改版本日志记录
    server.version_log_update = function (data, callback) {
        return send('post', contextPath + '/permissions/version/log/update', data, callback);
    };
})();