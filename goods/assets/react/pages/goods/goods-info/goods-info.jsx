...
class GoodsInfo extends React.Component {
        ...
        function setData(){
            if(goodsUnits && goodsSmuggles && goodsBrands && goodsClassData && activitiesType && goodsInfo && priceRules) {
                ...
                for(let i = 0 ; i < goodsUnits.length ; i++) {
                    if(goodsUnits[i].id == goodsInfo.basic_attributes.goods_unit_id){
                        unitText = goodsUnits[i].name;
                    }
                }
    ...
    */
    ...
    getGoodsSame() {
        ...
        if(param.guige.values.length <= 0 || param.xinghao.values.length <= 0) return;
    ...
    createSameXML() {
        ...
        return data.map((val, index) => {
            return (
                <div key={index} onClick={this.sameGoodsHandle.bind(this, val.id)}>
    ...
    //点击相似商品打开相似商品的详细信息;
    sameGoodsHandle(id) {
        window.open('/html/same-goods-info/index.html?goodsId='+id+'&areaId='+this.props.area,
                        ...
                        <div className="row">
                            ...
                            <div className="col-xs-12">
                                ...
                                <div>
                                    ...
                                    <div className="clearfix">
                                        <div className="input-inline">
                                            <p>商品图片（最少4张，最多可添加6张图片，最好是竖屏图片）</p>
                                            <div>
