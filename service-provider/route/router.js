...
//可推送用户列表;
router.get('/mock/service-provider/daily-news/receive-user/list', function (req, res) {
    console.log('可推送用户列表');
    res.sendFile('/service-provider/daily-news/receive-user/list.json', getOptions());
});

//今日推文列表;
router.get('/mock/service-provider/today-article/list', function (req, res) {
    console.log('今日推文列表');
    res.sendFile('/service-provider/today-article/list.json', getOptions());
});
...
//今日推文编辑（添加/修改）;
router.post('/mock/service-provider/today-article/edit', function (req, res) {
    console.log('今日推文编辑（添加/修改）');
    res.sendFile('/service-provider/today-article/edit.json', getOptions());
});

//今日推文删除;
router.post('/mock/service-provider/today-article/delete', function (req, res) {
    console.log('今日推文删除');
    res.sendFile('/service-provider/today-article/del.json', getOptions());
});

//推文商品列表;
router.get('/mock/service-provider/daily-news/goods/list', function (req, res) {
    console.log('推文商品列表');
    res.sendFile('/service-provider/daily-news/goods/list.json', getOptions());
});

//推文商品屏蔽操作;
router.post('/mock/service-provider/daily-news/goods/shield', function (req, res) {
    console.log('推文商品屏蔽操作');
    res.sendFile('/service-provider/daily-news/goods/shield.json', getOptions());
});
...
//推文日志列表;
router.get('/mock/service-provider/daily-news/log/list', function (req, res) {
    console.log('获取前端上传数据到OSS的请求ID');
    res.sendFile('/service-provider/daily-news/log/list.json', getOptions());
});

//每日推文设置get;
router.get('/mock/service-provider/daily-news/manage/list', function (req, res) {
    console.log('每日推文设置get');
    res.sendFile('/service-provider/daily-news/manage/list.json', getOptions());
});

//每日推文设置post;
router.post('/mock/service-provider/daily-news/manage/edit', function (req, res) {
    console.log('每日推文设置post');
    res.sendFile('/service-provider/daily-news/manage/edit.json', getOptions());
});
...
//添加推荐榜商品;
router.post('/mock/service-provider/daily-news/goods/recommend', function (req, res) {
    console.log('添加推荐榜商品');
    res.sendFile('/service-provider/daily-news/goods/recommend.json', getOptions());
});

//移除单个推荐榜商品;
router.post('/mock/service-provider/daily-news/recommend/goods/remove', function (req, res) {
    console.log('移除单个推荐榜商品');
    res.sendFile('/service-provider/daily-news/recommend/goods/remove.json', getOptions());
});

//移除全部推荐榜商品;
router.post('/mock/service-provider/daily-news/recommend/goods/remove-all', function (req, res) {
    console.log('移除单个推荐榜商品');
    res.sendFile('/service-provider/daily-news/recommend/goods/remove-list.json', getOptions());
});

//推荐榜商品排序;
router.post('/mock/service-provider/daily-news/recommend/goods/sort', function (req, res) {
    console.log('推荐榜商品排序');
    res.sendFile('/service-provider/daily-news/recommend/goods/sort.json', getOptions());
});
...
//服务商搜索提示
router.post('/mock/provider/hint', function (req, res) {
    console.log('服务商搜索提示');
    res.sendFile('provider/hint.json', getOptions());
});
