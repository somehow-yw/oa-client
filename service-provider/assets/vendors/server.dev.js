(function () {
    ...
    server.operate_dailyNews_receiveUser_list = function (data, callback) {
        return send('get', contextPath + '/service-provider/daily-news/receive-user/list', data, callback);
    };

    //今日推文列表;
    server.operate_todayArticle_list = function (data, callback) {
        return send('get', contextPath + '/service-provider/today-article/list', data, callback);
    };
    ...
    server.operate_todayArticle_edit = function (data, callback) {
        return send('post', contextPath + '/service-provider/today-article/edit', data, callback);
    };

    //今日推文删除;
    server.operate_todayArticle_delete = function (data, callback) {
        return send('post', contextPath + '/service-provider/today-article/delete', data, callback);
    };

    //推文商品列表;
    server.operate_dailyNews_goods_list = function (data, callback) {
        return send('get', contextPath + '/service-provider/daily-news/goods/list', data, callback);
    };

    //推文商品屏蔽操作;
    server.operate_dailyNews_goods_shield = function (data, callback) {
        return send('post', contextPath + '/service-provider/daily-news/goods/shield', data, callback);
    };
    ...
    server.operate_dailyNews_log_list = function (data, callback) {
        return send('get', contextPath + '/service-provider/daily-news/log/list', data, callback);
    };

    //每日推文设置
    server.operate_dailyNews_manage_list = function (data, callback) {
        return send('get', contextPath + '/service-provider/daily-news/manage/list', data, callback);
    };

    //每日推文设置发送
    server.operate_dailyNews_manage_edit = function (data, callback) {
        return send('post', contextPath + '/service-provider/daily-news/manage/edit', data, callback);
    };
    ...
    server.operate_dailyNews_goods_recommend = function (data, callback) {
        return send('post', contextPath + '/service-provider/daily-news/goods/recommend', data, callback);
    };

    //移除单个推荐榜商品;
    server.operate_dailyNews_recommend_goods_remove = function (data, callback) {
        return send('post', contextPath + '/service-provider/daily-news/recommend/goods/remove', data, callback);
    };

    //移除全部推荐榜商品;
    server.operate_dailyNews_recommend_goods_removeAll = function (data, callback) {
        return send('post', contextPath + '/service-provider/daily-news/recommend/goods/remove-all', data, callback);
    };

    //推荐榜商品排序;
    server.operate_dailyNews_recommend_goods_sort = function (data, callback) {
        return send('post', contextPath + '/service-provider/daily-news/recommend/goods/sort', data, callback);
    };
    ...
    * */
    ...
    server.provider_area = function (data, callback) {
        return send('get', contextPath + '/provider/area.json', data, callback);
    };
    //添加服务商区域
    server.provider_area_add = function (data, callback) {
        return send('get', contextPath + '/provider/area/add.json', data, callback);
    };
    //删除服务商区域
    server.provider_area_remove = function (data, callback) {
        return send('get', contextPath + '/provider/area/remove.json', data, callback);
    };
    //修改服务商区域
    server.provider_area_edit = function (data, callback) {
        return send('get', contextPath + '/provider/area/edit.json', data, callback);
    };
})();