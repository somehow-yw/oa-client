(function () {
    ...
    server.trade_list = function (data, callback) {
        return send('get', contextPath + '/logistics/list', data, callback);
    };
    //商贸公司添加;
    server.trade_add = function (data, callback) {
        return send('post', contextPath + '/logistics/add', data, callback);
    };
    //商贸公司信息获取;
    server.trade_info = function (data, callback) {
        return send('get', contextPath + '/logistics/info', data, callback);
    };
    //商贸公司信息修改;
    server.trade_info_update = function (data, callback) {
        return send('post', contextPath + '/logistics/info/update', data, callback);
    };
    //商贸公司状态修改;
    server.trade_status_update = function (data, callback) {
        return send('post', contextPath + '/logistics/status/update', data, callback);
    };

    //商贸公司运费规则列表;
    server.trade_fees_list = function (data, callback) {
        return send('get', contextPath + '/logistics/fees/list', data, callback);
    };
