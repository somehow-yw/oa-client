...
//商贸公司列表;
router.get('/mock/logistics/list', function (req, res) {
    console.log('商贸公司列表');
    res.sendFile('/logistics/list.json', getOptions());
});
//商贸公司添加;
router.post('/mock/logistics/add', function (req, res) {
    console.log('商贸公司添加');
    res.sendFile('/logistics/add.json', getOptions());
});
//商贸公司信息获取;
router.get('/mock/logistics/info', function (req, res) {
    console.log('商贸公司信息获取');
    res.sendFile('/logistics/info.json', getOptions());
});
//商贸公司信息修改;
router.post('/mock/logistics/info/update', function (req, res) {
    console.log('商贸公司信息修改');
    res.sendFile('/logistics/info/update.json', getOptions());
});
//商贸公司状态修改;
router.post('/mock/logistics/status/update', function (req, res) {
    console.log('商贸公司状态修改');
    res.sendFile('/logistics/status/update.json', getOptions());
});
//商贸公司运费规则列表;
router.get('/mock/logistics/fees/list', function (req, res) {
    console.log('商贸公司运费规则列表');
    res.sendFile('/logistics/fees/list.json', getOptions());
});
