class Privilege extends React.Component {
    ...
    chooseChange(id, parentId, ancestorId) {
        console.log(id, parentId, ancestorId);
        let node = $('#' + id);
                                ...
                                <li key={'itemXml_' + k}>
                                    <div className="navigates-item">
                                        <div id={'choose_' + i + '_' + n +'_'+ k}
                                             ...
                                             onClick={this.chooseChange.bind(this, 'choose_' + i + '_' + n +'_'+ k, 'open_' + i + n, 'open_' + i)}
                                        ></div>
                    ...
                    <li id={'open_' + i} className="toggle-open" key={'oneXml_' + i}>
                        ...
                        <div className="navigates-item">
                            <div id={'choose_' + i}
                                 ...
                                 onClick={this.chooseChange.bind(this, 'choose_' + i, 'open_all', '')}
                            ></div>
