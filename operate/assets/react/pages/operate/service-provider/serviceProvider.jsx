...
class  ServiceProvider extends React.Component {
    ...
    createTable() {
        ...
        this.state.serviceList.map((service, index)=>{
            ...
            if(service.status == 1){
                ...
                statusOperate[index] = ['查看', '完善微信信息', '初始化微信配置', '关闭', '删除'];
    ...
    delSp(shopId){
        ...
        H.Modal({
            ...
            okText: '确认',
            okCallback: ()=>{
                H.server.del_sp({sp_id: shopId}, (res)=>{
                    if(res.code == 0) {
                        H.Modal('# 操作成功 #');
                        this.getData();
                    }else if(res.code == 10106) {
            ...
            <div className="section-warp">
                <div className="section-table">
                    ...
                    <div className="col-lg-12" >
                        ...
                        <Paging pageNum={this.state.page} maxPage={Math.ceil(this.state.total/this.state.size)} clickCallback={this.setPageNum.bind(this)}/>
                    </div>
                </div>
            </div>
        );
