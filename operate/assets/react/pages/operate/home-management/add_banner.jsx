            ...
            <div className="waybill-info-head container-fluid">
                ...
                <div className="waybill-info-content" style={{overflowY:'scroll'}}>
                    ...
                    <div className="section-filter">
                        <p>图片上传成功后，才可提交确认</p>
                        {this.state.canSubmit?<button type="button" className="btn btn-lg btn-orange" onClick={this.saveBanner.bind(this)}>{this.state.btnName}</button>:<button type="button" className="btn btn-lg btn-orange" disabled="disabled" onClick={this.saveBanner.bind(this)}>提交确认</button>}
