...
class DropDown extends React.Component {
    ...
    selChange() {
        if (this.props.changeEv) {
            this.props.changeEv(this.refs.selectNode.value, this.props.opearte);
        }
    ...
    render() {
        ...
        return (
            <select value={this.state.val} className="form-control" onChange={this.selChange} ref="selectNode" opearte={this.props.opearte}>
                {DomXml}
            </select>
        );
    }
